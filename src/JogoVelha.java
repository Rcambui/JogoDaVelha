...
public class JogoVelha {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(!ganhou) {
            ...
            //Fazendo as verificações de entrada:
            boolean linhaValida = false;
            while (!linhaValida) {
                System.out.println("Entre com a linha que deseja jogar: 1, 2 ou 3");
                linha = scan.nextInt();
                if (linha >=1 && linha <=3) {
                    linhaValida = true;
                }
            ...
            while (!colunaValida) {
                System.out.println("Entre com a coluna que deseja jogar: 1, 2 ou 3");
                coluna = scan.nextInt();
            ...
            if (jogoVelha[linha][coluna] == 'X' || jogoVelha[linha][coluna] == 'O') {
                System.out.println("Espaço já ocupado. Escolha outro lugar");
            }
            else {
            ...
            if ((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X') ||
                ...
                ganhou = true;
                System.out.println("Empate. Não temos um ganhador");
            }
        }
